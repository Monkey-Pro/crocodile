...
import (
	...
	"crocodile/core/router/api/v1/host"
	"crocodile/core/router/api/v1/hostgroup"
	"crocodile/core/router/api/v1/install"
	"crocodile/core/router/api/v1/notify"
	"crocodile/core/router/api/v1/task"
	"crocodile/core/router/api/v1/user"
	"crocodile/core/schedule"
	"crocodile/core/utils/asset"
	"crocodile/core/utils/define"
	"github.com/gin-contrib/pprof"

	_ "crocodile/core/docs" // init swagger docs
